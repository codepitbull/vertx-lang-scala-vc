...
import io.vertx.core.Handler
  ...
  implicit class MqttClientScala(val asJava: io.vertx.mqtt.MqttClient) extends AnyVal {
     ...
     */
    def connectFuture(port: java.lang.Integer, host: String): scala.concurrent.Future[io.vertx.mqtt.messages.MqttConnAckMessage] = {
     ...
     * Like [[connect]] but returns a [[scala.concurrent.Future]] instead of taking an AsyncResultHandler.
     */
    def connectFuture(port: java.lang.Integer, host: String, serverName: String): scala.concurrent.Future[io.vertx.mqtt.messages.MqttConnAckMessage] = {
      val promise = Promise[io.vertx.mqtt.messages.MqttConnAckMessage]()
     ...
     */
    def publishFuture(topic: String, payload: io.vertx.core.buffer.Buffer, qosLevel: io.netty.handler.codec.mqtt.MqttQoS, isDup: java.lang.Boolean, isRetain: java.lang.Boolean): scala.concurrent.Future[java.lang.Integer] = {
     ...
     */
    def subscribeFuture(topic: String, qos: java.lang.Integer): scala.concurrent.Future[java.lang.Integer] = {
      val promise = Promise[java.lang.Integer]()
     ...
     */
    def unsubscribeFuture(topic: String): scala.concurrent.Future[java.lang.Integer] = {
      val promise = Promise[java.lang.Integer]()
...
import io.vertx.mqtt.MqttServer
  ...
  implicit class MqttServerScala(val asJava: io.vertx.mqtt.MqttServer) extends AnyVal {
     ...
     */
    def listenFuture(port: java.lang.Integer, host: String): scala.concurrent.Future[io.vertx.mqtt.MqttServer] = {
