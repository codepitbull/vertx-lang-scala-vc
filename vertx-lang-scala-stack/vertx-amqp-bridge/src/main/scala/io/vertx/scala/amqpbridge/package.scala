//MODULE: vertx-amqp-bridge
//MODULE: io.vertx.amqpbridge
//MODULE: io.vertx
//MODULE: io.vertx.scala.amqpbridge
/*
...
import io.vertx.amqpbridge.AmqpBridgeOptions
  ...
  implicit class AmqpBridgeScala(val asJava: io.vertx.amqpbridge.AmqpBridge) extends AnyVal {
     ...
     */
    def startFuture(hostname: String, port: java.lang.Integer, username: String, password: String): scala.concurrent.Future[io.vertx.amqpbridge.AmqpBridge] = {
     ...
     * Like [[start]] but returns a [[scala.concurrent.Future]] instead of taking an AsyncResultHandler.
     */
    def startFuture(hostname: String, port: java.lang.Integer): scala.concurrent.Future[io.vertx.amqpbridge.AmqpBridge] = {
      val promise = Promise[io.vertx.amqpbridge.AmqpBridge]()
